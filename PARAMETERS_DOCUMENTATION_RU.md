...
- **Формат**: `https://youtube.com/watch?v=VIDEO_ID` или `VIDEO_ID`
- **Пример**: `"https://www.youtube.com/watch?v=dQw4w9WgXcQ"` или `dQw4w9WgXcQ`

#### `START` (опциональный)
- **Описание**: Время начала сегмента для скачивания
- **Форматы**:
  - `45` (секунды)
  - `45.5` (секунды.миллисекунды)
  - `1:30` (минуты:секунды)
...
- **Формат**: Текст произвольной длины
...
### Простые форматы
- `45` - 45 секунд
- `45.5` - 45 секунд 500 миллисекунд
